...
def convert_transpose(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
    Convert transpose.
...
def convert_shape(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
    Convert shape.
    :param node: current operation node
    :param params: operation attributes
...
def convert_gather(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
    Convert gather.
    :param node: current operation node
    :param params: operation attributes
...
def convert_concat(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
    Convert concat.
    :param node: current operation node
    :param params: operation attributes
...
def convert_reshape(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
    Convert reshape.
    :param node: current operation node
    :param params: operation attributes
...
def convert_unsqueeze(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
    Convert unsqueeze.
    :param node: current operation node
    :param params: operation attributes
...
def convert_flatten(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
    Convert flatten.
    :param node: current operation node
    :param params: operation attributes
...
def convert_slice(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
    Convert slice.
    :param node: current operation node
    :param params: operation attributes
...
def convert_squeeze(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
...
def convert_expand(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
    ...
    def target_layer(x, shape=tuple(input_1)):
        from tensorflow import keras
