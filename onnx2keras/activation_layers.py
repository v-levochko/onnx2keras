...
def convert_relu(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
...
def convert_relu6(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
    Convert ReLU activation layer
    :param node: current operation node
    :param params: operation attributes
    ...
    relu = keras.layers.ReLU(max_value=6, name=keras_name)
    layers[node_name] = relu(input_0)


def convert_elu(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
...
def convert_lrelu(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
...
def convert_sigmoid(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
...
def convert_tanh(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
...
def convert_selu(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
...
def convert_softmax(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
...
def convert_prelu(node, params, layers, lambda_func, custom_objects, node_name, keras_name):
    """
